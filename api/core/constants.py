...
class Countries:
    """Full ISO 3166-1 alpha-2 list (code, English short name). Used by every
    new/updated country-of-residence and target-market dropdown across
    registration, candidate profiles, and settings. Nationalities above is a
    separate, shorter, already-in-production list for a different field
    (citizenship) - intentionally left untouched by this."""
...
class AuditLogAction:
    ...
    EVALUATOR_RATING_SUBMITTED = "EVALUATOR_RATING_SUBMITTED"
    ...
    CHOICES = [
        ...
        (EVALUATOR_RATING_SUBMITTED, "Evaluator Rating Submitted"),
