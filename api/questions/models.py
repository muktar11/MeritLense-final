...
from api.core.constants import InterviewEvaluationTier, InterviewQuestionType, QuestionDifficulty
...
class QuestionTemplate(TimeStampedModel):
    ...
    question_type = models.CharField(
        ...
        default=InterviewQuestionType.TEXT,
    )
    ...
    def __str__(self):
        return f"{self.role_name} - {self.skill_tag} - {self.difficulty}"
