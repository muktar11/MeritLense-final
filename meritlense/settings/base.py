...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "api.accounts.authentication.PasswordChangeAwareJWTAuthentication",
...
AZURE_QUEUE_POLL_INTERVAL_SECONDS = int(os.getenv("AZURE_QUEUE_POLL_INTERVAL_SECONDS", "5"))
...
IDENTITY_VERIFICATION_PROVIDER = os.getenv("IDENTITY_VERIFICATION_PROVIDER", "DIRECT").upper()
IDENTITY_VERIFICATION_API_URL = os.getenv("IDENTITY_VERIFICATION_API_URL", "")
IDENTITY_VERIFICATION_FRAME_API_URL = os.getenv(
    "IDENTITY_VERIFICATION_FRAME_API_URL",
    os.getenv("IDENTITY_VERIFICATION_API_URL", ""),
)
IDENTITY_VERIFICATION_API_KEY = os.getenv("IDENTITY_VERIFICATION_API_KEY", "")
IDENTITY_VERIFICATION_TIMEOUT_SECONDS = int(os.getenv("IDENTITY_VERIFICATION_TIMEOUT_SECONDS", "20"))
IDENTITY_VERIFICATION_MATCH_THRESHOLD = float(os.getenv("IDENTITY_VERIFICATION_MATCH_THRESHOLD", "20.0"))
...
# "Sign in with Google" on the login page (existing accounts only - see
# api/accounts/oauth_views.py). No client secret needed: the frontend uses
# Google Identity Services to get an ID token, and this ID (used as the
# verification audience) is the only value the backend needs.
